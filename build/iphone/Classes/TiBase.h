...
{\
	NSString * exceptionName = [@"org.dolarparalelo." stringByAppendingString:NSStringFromClass([self class])];\
...
enum {
	UIdolarparaleloNativeItemNone = -1, 
	UIdolarparaleloNativeItemSpinner = -2,
	UIdolarparaleloNativeItemProgressBar = -3,
	
	UIdolarparaleloNativeItemSlider = -4,
	UIdolarparaleloNativeItemSwitch = -5,
	UIdolarparaleloNativeItemMultiButton = -6,
	UIdolarparaleloNativeItemSegmented = -7,
	
	UIdolarparaleloNativeItemTextView = -8,
	UIdolarparaleloNativeItemTextField = -9,
	UIdolarparaleloNativeItemSearchBar = -10,
	
	UIdolarparaleloNativeItemPicker = -11,
	UIdolarparaleloNativeItemDatePicker = -12,
	
	UIdolarparaleloNativeItemInfoLight = -13,
	UIdolarparaleloNativeItemInfoDark = -14,
	
	UIdolarparaleloNativeItemDisclosure = -15,
	
	UIdolarparaleloNativeItemContactAdd = -16
};
...
// in simulator we redefine to format for dolarparalelo Developer console
